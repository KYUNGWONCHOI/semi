...
<div>ID : <input type="text" name="id" required><button type="button" class="btn checkid">중복확인</button></div>
<div>PW : <input type="password" name="pwd" required></div>
<div><input type="file" name="memphoto" required></div>
