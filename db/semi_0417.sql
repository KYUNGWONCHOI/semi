...
DROP SEQUENCE "SEQ_LESSON_WEEKDAY";
DROP SEQUENCE "SEQ_NOTICE_NO";


CREATE SEQUENCE SEQ_NOTICE_NO;
CREATE SEQUENCE SEQ_LESSON_WEEKDAY;
...
CREATE TABLE "LESSON" (
	...
	"LESSON_LEVEL"	NUMBER      ,
	"LESSON_START"	DATE	DEFAULT SYSDATE,
	"LESSON_END"	DATE		,
	"TEACHER_NAME"	VARCHAR2(40)		,
	"LESSON_TIME"	NUMBER		NOT NULL,
	"LESSON_DAY"	VARCHAR2(20)		NOT NULL,
...
COMMENT ON COLUMN "LESSON"."TEACHER_NAME" IS '강사';

COMMENT ON COLUMN "LESSON"."LESSON_TIME" IS '시간';

COMMENT ON COLUMN "LESSON"."LESSON_DAY" IS '요일';

COMMENT ON COLUMN "LESSON"."LESSON_DURATION" IS '기간';
...
ALTER TABLE BOARD_PROBLEM ADD (PROB_SUBJECT VARCHAR2(100));
DESC BOARD_PROBLEM;
ALTER TABLE BOARD_PROBLEM MODIFY (PROB_SUBJECT VARCHAR2(100) NOT NULL);
UPDATE BOARD_PROBLEM SET PROB_SUBJECT = 'SUBJECT';
--@@
...
CREATE TABLE "BOARD_ASK" (
    ...
    "ASK_SUBJECT" VARCHAR2(100) NOT NULL,
...
COMMENT ON COLUMN "BOARD_ASK"."ASK_PWN_YN" IS '비밀글 YN';
...
ALTER TABLE "BOARD_ASK" ADD CONSTRAINT "PK_ASK" PRIMARY KEY (
	"BOARD_ASK_NO"
);
...
ALTER TABLE "BOARD_ASK" ADD CONSTRAINT "FK_MEMBER_TO_ASK_1" FOREIGN KEY (
	"MEMBER_ID"
)
REFERENCES "MEMBER" (
	"ID"
